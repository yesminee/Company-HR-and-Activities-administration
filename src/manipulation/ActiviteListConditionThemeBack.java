...
@WebServlet("/ActiviteListConditionThemeBack")
public class ActiviteListConditionThemeBack extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ActiviteListConditionThemeBack() {
        super();
		...
		if(theme!=null) {
			...
			try {
				...
				for(int i=0;i<theme.length;i++) {
					...
					stmt.setInt(i+2,Integer.parseInt( theme[i]));
				}
